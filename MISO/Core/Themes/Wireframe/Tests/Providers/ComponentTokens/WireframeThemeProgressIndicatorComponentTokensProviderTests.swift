...
struct WireframeThemeProgressIndicatorComponentTokensProviderTests {

    private var provider: WireframeThemeProgressIndicatorComponentTokensProvider

    init() {
        provider = WireframeThemeProgressIndicatorComponentTokensProvider()
    }
