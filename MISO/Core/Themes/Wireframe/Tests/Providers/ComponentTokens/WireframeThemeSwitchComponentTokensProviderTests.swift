...
struct WireframeThemeSwitchComponentTokensProviderTests {

    private var provider: WireframeThemeSwitchComponentTokensProvider

    init() {
        provider = WireframeThemeSwitchComponentTokensProvider()
    }
