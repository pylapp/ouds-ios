...
struct WireframeThemeButtonComponentTokensProviderTests {

    private var provider: WireframeThemeButtonComponentTokensProvider

    init() {
        provider = WireframeThemeButtonComponentTokensProvider()
    }
