...
struct WireframeThemeChipComponentTokensProviderTests {

    private var provider: WireframeThemeChipComponentTokensProvider

    init() {
        provider = WireframeThemeChipComponentTokensProvider()
    }
