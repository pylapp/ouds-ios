...
struct WireframeThemeCategoricalTagComponentTokensProviderTests {

    private var provider: WireframeThemeCategoricalTagComponentTokensProvider

    init() {
        provider = WireframeThemeCategoricalTagComponentTokensProvider()
    }
