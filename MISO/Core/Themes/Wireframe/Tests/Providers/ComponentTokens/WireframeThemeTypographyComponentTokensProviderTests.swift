...
struct WireframeThemeTypographyComponentTokensProviderTests {

    private var provider: WireframeThemeTypographyComponentTokensProvider

    init() {
        provider = WireframeThemeTypographyComponentTokensProvider()
    }
