...
struct WireframeThemeAccordionComponentTokensProviderTests {

    private var provider: WireframeThemeAccordionComponentTokensProvider

    init() {
        provider = WireframeThemeAccordionComponentTokensProvider()
    }
